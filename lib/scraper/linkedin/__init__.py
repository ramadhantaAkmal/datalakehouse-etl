...
from scraper.exception import LinkedInException
from scraper.linkedin.constant import headers
from scraper.linkedin.util import (
    is_job_remote,
    job_type_code,
    parse_job_type,
    parse_job_level,
            ...
            for job_card in job_cards:
                ...
                if href_tag and "href" in href_tag.attrs:
                    ...
                    try:
                        ...
                        # if scraper_input.search_term.lower() in title.lower():
